...
const LineChartLazy = lazy(() =>
  import("@sunbeam/beam-ui/charts").then((m) => ({
    default: m.LineChart as ComponentType<any>,
  }))
);
const BarChartLazy = lazy(() =>
  import("@sunbeam/beam-ui/charts").then((m) => ({
    default: m.BarChart as ComponentType<any>,
  }))
);
const PieChartLazy = lazy(() =>
  import("@sunbeam/beam-ui/charts").then((m) => ({
    default: m.PieChart as ComponentType<any>,
  }))
);
const AreaChartLazy = lazy(() =>
  import("@sunbeam/beam-ui/charts").then((m) => ({
    default: m.AreaChart as ComponentType<any>,
  }))
);
const CodeEditorLazy = lazy(() =>
  import("@sunbeam/beam-ui/code-editor").then((m) => ({
    default: m.CodeEditor as ComponentType<any>,
  }))
);
const DiagramRendererLazy = lazy(() =>
  import("@sunbeam/beam-ui/diagram").then((m) => ({
    default: m.DiagramRenderer as ComponentType<any>,
  }))
);
const KanbanCardViewLazy = lazy(() =>
  import("@sunbeam/beam-ui/kanban").then((m) => ({
    default: m.KanbanCardView as ComponentType<any>,
  }))
);
const KanbanCardDetailLazy = lazy(() =>
  import("@sunbeam/beam-ui/kanban").then((m) => ({
    default: m.KanbanCardDetail as ComponentType<any>,
  }))
);
const MarkdownEditorLazy = lazy(() =>
  import("@sunbeam/beam-ui/markdown").then((m) => ({
    default: m.MarkdownEditor as ComponentType<any>,
  }))
);
const MarkdownRendererLazy = lazy(() =>
  import("@sunbeam/beam-ui/markdown").then((m) => ({
    default: m.MarkdownRenderer as ComponentType<any>,
  }))
);
const MathRendererLazy = lazy(() =>
  import("@sunbeam/beam-ui/math").then((m) => ({
    default: m.MathRenderer as ComponentType<any>,
  }))
);
const SyntaxHighlighterLazy = lazy(() =>
  import("@sunbeam/beam-ui/syntax-highlighter").then((m) => ({
    default: m.SyntaxHighlighter as ComponentType<any>,
  }))
);
...
export function registerBeamComponents(): void {
  ...
  registerComponent(
    withSanitizedProps(ActivityHeatmap),
    metaBeamActivityHeatmap,
  );
  ...
  registerComponent(
    withSanitizedProps(ForgotPasswordForm),
    metaBeamForgotPasswordForm,
  );
  ...
  const metaBeamCodeEditor = withOverride("CodeEditor", {
    ...
    "props": {
      ...
      "extensions": {
        "type": "object",
        "description":
          "Extra CodeMirror extensions to append. Typed as unknown[] to avoid Extension symbol mismatch when the caller uses a different",
        "advanced": true,
      },
    },
  });
  ...
  registerComponent(
    withSanitizedProps(DiagramRendererHost),
    metaBeamDiagramRenderer,
  );
  ...
  registerComponent(
    withSanitizedProps(KanbanCardViewHost),
    metaBeamKanbanCardView,
  );
  ...
  registerComponent(
    withSanitizedProps(KanbanCardDetailHost),
    metaBeamKanbanCardDetail,
  );
  ...
  registerComponent(
    withSanitizedProps(MarkdownEditorHost),
    metaBeamMarkdownEditor,
  );
  ...
  registerComponent(
    withSanitizedProps(MarkdownRendererHost),
    metaBeamMarkdownRenderer,
  );
  ...
  registerComponent(
    withSanitizedProps(MilestonePicker),
    metaBeamMilestonePicker,
  );
  ...
  registerComponent(
    withSanitizedProps(NotificationItem),
    metaBeamNotificationItem,
  );
  ...
  registerComponent(
    withSanitizedProps(NotificationCenter),
    metaBeamNotificationCenter,
  );
  ...
  registerComponent(
    withSanitizedProps(SyntaxHighlighterHost),
    metaBeamSyntaxHighlighter,
  );
...
import { type ComponentOverride, overrides } from "./registry.overrides";
