...
export default defineConfig({
  preflight: true,
  // Canonical Beam Design Language tokens live here.
  // The @sunbeam/beam-ui package components are consumed as source and
  // rely on this Panda config for token resolution.
