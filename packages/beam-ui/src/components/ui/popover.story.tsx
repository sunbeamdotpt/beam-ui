...
export function WithoutTitle() {
  return (
    <div style={{ padding: 40 }}>
      <Popover trigger={<button>No Title</button>}>
...
export function RichContent() {
  return (
    <div style={{ padding: 40 }}>
      <Popover trigger={<button>Details</button>} title="Repository Info">
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          <p style={{ margin: 0, fontWeight: 600 }}>sunbeam/beam-ui</p>
          <p style={{ margin: 0, fontSize: 13, opacity: 0.7 }}>A design system built on warm amber tones.</p>
        </div>
      </Popover>
    </div>
  );
